--last updated: June 16, 2026 at 06:11 PM
-- 0. Wipe Old Data
...
INSERT INTO stock_prices (stock_id, symbol, trade_date, open_price, high_price, low_price, close_price, volume) VALUES ((SELECT id FROM stocks WHERE symbol='INFY'), 'INFY', '2026-06-01', 1600, 1625, 1590, 1613.0, 90000.0);
...
INSERT INTO stock_prices (stock_id, symbol, trade_date, open_price, high_price, low_price, close_price, volume) VALUES ((SELECT id FROM stocks WHERE symbol='ICICIBANK'), 'ICICIBANK', '2026-06-02', -1110, 1130, 1100, 1120.0, 138000.0);
...
INSERT INTO stock_prices (stock_id, symbol, trade_date, open_price, high_price, low_price, close_price, volume) VALUES ((SELECT id FROM stocks WHERE symbol='BHARTIARTL'), 'BHARTIARTL', '2026-06-01', 1500, 1525, 10, 1510.0, 145000.0);
INSERT INTO stock_prices (stock_id, symbol, trade_date, open_price, high_price, low_price, close_price, volume) VALUES ((SELECT id FROM stocks WHERE symbol='BHARTIARTL'), 'BHARTIARTL', '2026-06-02', 1510, 1530, 1500, 1525.0, -148000.0);
...
INSERT INTO stock_prices (stock_id, symbol, trade_date, open_price, high_price, low_price, close_price, volume) VALUES ((SELECT id FROM stocks WHERE symbol='INFY'), 'INFY', '2026-06-07', 1640, 1655, 1630, 1645.0, 96000.0);
INSERT INTO stock_prices (stock_id, symbol, trade_date, open_price, high_price, low_price, close_price, volume) VALUES ((SELECT id FROM stocks WHERE symbol='INFY'), 'INFY', '2026-06-08', 1650, 1665, 1640, 1655.0, 97000.0);
...
INSERT INTO stock_prices (stock_id, symbol, trade_date, open_price, high_price, low_price, close_price, volume) VALUES ((SELECT id FROM stocks WHERE symbol='HDFCBANK'), 'HDFCBANK', '2026-06-10', 1750, 1700, 1740, 1745.0, 131000.0);
INSERT INTO stock_prices (stock_id, symbol, trade_date, open_price, high_price, low_price, close_price, volume) VALUES ((SELECT id FROM stocks WHERE symbol='ITC'), 'ITC', '2026-06-11', 440, 438, 435, 437.0, 212000.0);
...
INSERT INTO stock_prices (stock_id, symbol, trade_date, open_price, high_price, low_price, close_price, volume) VALUES ((SELECT id FROM stocks WHERE symbol='TCS'), 'TCS', '2026-06-14', 3500, 3620, 3590, 3500.0, 88.0);
