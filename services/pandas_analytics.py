...
class PandasAnalyticsService:
    def __init__(self):
        ...
        try:
            self.df = pd.read_csv('data/clean_stock_prices.csv')
    ...
    def get_market_analysis(self):
        ...
        print(f'highest closing price is of {highestclosingprice['symbol']}: inr {highestclosingprice['close_price']}')
    ...
    def show_filtered_views(self):
        ...
        high_volume = self.df[self.df['volume'] > 80000]
        print("\n[High Volume Stocks > 80k]")
        print(high_volume)
