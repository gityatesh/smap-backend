"""
Django settings for smap_web project.
...
#loading the environment variables from our .env files
load_dotenv()
...
WSGI_APPLICATION = 'smap_web.wsgi.application'
